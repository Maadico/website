...
function Privacy() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">Last updated: March 21, 2024</p>
      <p className="mb-4">
      ...
      <h2 className="my-2 text-xl">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="my-2 text-xl">Delete Your Personal Data</h2>
      <p>
      ...
      <h2 className="my-2 text-xl">Disclosure of Your Personal Data</h2>
      ...
      <h3 className="my-2 text-xl">Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="my-2 text-xl">Other legal requirements</h3>
      <p>
      ...
      <h2 className="my-2 text-xl">Security of Your Personal Data</h2>
      <p>
      ...
      <h2 className="my-2 text-xl">Analytics</h2>
      <p>
        We may use third-party Service providers to monitor and analyze the use
        of our Service.
      </p>
      <h2 className="my-2 text-xl">Children's Privacy</h2>
      <p>
      ...
      <h2 className="my-2 text-xl">Contact Us</h2>
      <p>
