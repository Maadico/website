...
function Terms() {
  return (
    <div className="privacy-container">
      <h1 className="text-3xl font-bold mb-4">Welcome to Maadico!</h1>
      <p className="mb-4">
        These terms and conditions outline the rules and regulations for the use
        of Maadico's Website, located at https://Maadico.in.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        Maadico for your own personal use subjected to restrictions set in these
      ...
      <p className="mb-4">
        ...
        Maadico does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Maadico,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Maadico shall not be liable for the
      ...
      <p className="mb-4">
        You hereby grant Maadico a non-exclusive license to use, reproduce, edit
        and authorize others to use, reproduce and edit any of your Comments in
        any and all forms, formats or media.
      </p>
      <h2 className="mb-4 text-xl">Hyperlinking to our Content</h2>
      <p>
      ...
      <p className="mb-4">
        ...
        the hyperlink compensates the absence of Maadico; and (d) the link is in
      ...
      <p className="mb-4">
        ...
        e-mail to Maadico. Please include your name, your organization name,
      ...
      <h2 className="text-3xl font-bold mb-4">iFrames</h2>
      <p>
