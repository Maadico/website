    ...
    <div>
      <div className="container">
        <section class="mt-4">
          ...
          <p>
            We charge a flat shipping charge per order irrespective of the order
            size and value. Flat rates apply and the customers can choose from
            the below options at the time of checkout:
          </p>
          <p>
            <strong>Standard Shipping: Rs. 50</strong>
          </p>
          <p>
            The orders are shipped within 6-7 working days from the date it is
            received. Shipping details will be shared on the registered mobile
            number and Email ID (if shared).
          </p>
          <p>
            Cancellation cannot be requested once an order is shipped out from
            our warehouse.
          </p>
          {/* <div className="row">
            <h1>Overview</h1>
            <p className="mb-2">
              ...
              <a href=" https://www.maadico.in/"> https://www.maadico.in/</a> is
              operated by MaaDico Healthcare LLP Throughout the site, the terms
              “we”, “us” and “our” refer to offers this website, including all
          ...
          <div className="row">
            ...
            <div className="row">
              ...
              <div className="row">
                ...
                <p className="mb-2">
                  In no case shall , our partners, officers, employees,
              ...
              <div className="row">
                ...
                <p className="mb-2">
                  You agree to indemnify, defend and hold harmless and our
              ...
              <div className="row">
                ...
                <p className="mb-2">
                  Questions about the Terms of Service should be sent to us at  <a href="mailto:maadico.in@gmail.com">Send an email to Maadico</a>
                </p>
              </div>
            </div>
          </div> */}
